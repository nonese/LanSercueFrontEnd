$.post("http://192.168.2.184:82/api/user/list?role=admin",
{
},
...
$.post("http://192.168.2.184:82/api/user/list",
{
    role:"op",
},
function(data,status){
...
function adduser(element){
    ...
    console.log(result)
    $.post("http://192.168.2.184:82/api/user/AddUser",
    {
...
function deluser(element){
    ...
    console.log(id);
    $.post("http://192.168.2.184:82/api/user/del",
    {
        username:id,
    },
    function(data,status){
